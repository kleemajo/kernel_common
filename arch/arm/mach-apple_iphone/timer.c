...
#define TIMER IO_ADDRESS(0x3C700000)
...
const TimerRegisters HWTimers[] = {
		...
		{	TIMER + TIMER_7 + TIMER_CONFIG, TIMER + TIMER_7 + TIMER_STATE, TIMER + TIMER_7 + TIMER_COUNT_BUFFER,
			TIMER + TIMER_7 + TIMER_COUNT_BUFFER2, TIMER + TIMER_7 + TIMER_PRESCALER, TIMER + TIMER_7 + TIMER_UNKNOWN3 },
	};
